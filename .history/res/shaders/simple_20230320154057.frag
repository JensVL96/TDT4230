...
// vec4 diffuseTextureColor = texture(normalMapTexture, textureCoordinates);
vec3 diffuseTextureColor = texture(normalMapTexture, textureCoordinates).xyz*vec3(1, 1, -1) * 2 - 1;
