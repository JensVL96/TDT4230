...
void loadCubemap(GLuint *textureID, std::vector<std::string> faces) {
...
void initGame(GLFWwindow* window, CommandLineOptions gameOptions) {
    ...
    Mesh skybox = cube(boxDimensions, glm::vec2(90), true, true);
    ...
    skyboxNode->textureID            = skyboxTexID;
...
void renderNode(SceneNode* node) {
    ...
    glUniformMatrix4fv(4, 1, GL_FALSE, glm::value_ptr(PV));
